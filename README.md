...
O **Cabo** de energia (`futuretech:cable_mk1` a `cable_mk4`) transporta energia entre blocos que não estão encostados. Cabos que se tocam formam uma rede única, de qualquer MK; a rede anda no ritmo do MK mais lento que tiver.

- Cada MK dobra o anterior, como as baterias: **MK1 400 FE/t, MK2 800, MK3 1.600, MK4 3.200** para a rede inteira. O miolo leva a cor do MK — branco, amarelo, vermelho, ciano, as mesmas linhas da bateria e quinas das máquinas — e o tampão do colar acompanha (`CableBlock.contactTexture()`, um por bloco).
...
O **Cabo de Itens** (`futuretech:item_cable`) é o irmão do cabo de energia para itens: mesma geometria e mesmos conectores, em cinza (o amarelo que ele tinha é hoje a cor do Cabo MK2). Cabos de itens que se tocam formam uma rede; um cabo de itens ao lado de um cabo de energia é só um vizinho, nunca continuação.
